...
# 🎮 Sandustry — Community Edition

**Physics-driven factory automation in a fully simulated sandbox.**
...
Sandustry is a physics-driven sandbox game where falling-sand simulation meets factory automation. Dig into destructible terrain, mine raw resources, and build automated production chains to industrialize a fully simulated world. This Community Edition is a self-contained package that is ready to play immediately, with no additional software required.

This build is for players who enjoy sandbox automation, physics simulations, and open-ended factory-building games.
...
<table>
 <tr>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2764460/9c0dbea0095a02663a62b127bddf82dc51bc923f/ss_9c0dbea0095a02663a62b127bddf82dc51bc923f.1920x1080.jpg?t=1787905620" alt="Screenshot 1" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2764460/803eb69d876248ef032dc9b063a3b6bbe664e333/ss_803eb69d876248ef032dc9b063a3b6bbe664e333.1920x1080.jpg?t=1787905620" alt="Screenshot 2" width="100%"></td>
 <td width="33%"><img src="https://shared.akamai.steamstatic.com/store_item_assets/steam/apps/2764460/787cbcb26158344c254a2f362085555934c3db29/ss_787cbcb26158344c254a2f362085555934c3db29.1920x1080.jpg?t=1787905620" alt="Screenshot 3" width="100%"></td>
 </tr>
</table>
...
- ✅ **No Steam, GOG / Microsoft Store account required**
...
- **Interface:** English, French, German, Spanish, Portuguese-Brazil, Russian, Simplified Chinese
- **Voiceover:** None
...
- 🏗️ **Factory Automation** — Design conveyor networks and machines to process raw materials into refined goods.
- ⏳ **Falling-Sand Physics** — Every particle of sand, water, and ore is simulated in real time.
- ⛏️ **Mining & Excavation** — Dig through fully destructible terrain to extract valuable resources.
- 🧪 **Resource Processing** — Refine ore through multi-stage production chains to enable advanced materials.
- 🌍 **Sandbox World** — Open-ended building with no imposed objectives — shape the world at your own pace.
- 🎨 **Pixel Art Visuals** — Crisp pixel-art presentation paired with dynamic particle effects.
- 🔌 **Fully Offline** — Standalone build runs entirely offline with no storefront required.
- 💾 **Lightweight Footprint** — Small storage requirements and smooth performance on modest hardware.
...
| **RAM** | 4 GB | 8 GB |
| **Graphics** | Intel HD Graphics 4000 / DirectX 11 compatible | Dedicated GPU with 2 GB VRAM |
| **Storage** | 1 GB available space | 2 GB available space (SSD) |
| **Additional** | DirectX 11, keyboard and mouse | DirectX 11, keyboard and mouse, SSD storage |
...
> 💡 **Saves location:** `%LOCALAPPDATA%\Sandustry\Saved`
